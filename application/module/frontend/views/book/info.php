<?php 
$title_page = $this->Book['name'];
$name       = $this->Book['name'];
$picture    = UPLOAD_URL .'book' . DS . $this->Book['picture'];

$sale_book_Off    = '';
if($this->Book['sale_off']>0){
    $sale_book_Off = '-'.$this->Book['sale_off'].'%';
}
...
if($this->Book['sale_off'] > 0){
    ...
    $price          = number_format($price * (100 - $this->Book['sale_off']) / 100);
    $price          = $price.' đ ';
} else{
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-xl-8 rtl-text">
                                <div class="product-right">
                                    ...
                                    <h4><?php echo $priceNotSaleOFF;?><span> <?php echo $sale_book_Off;?></span></h4>
