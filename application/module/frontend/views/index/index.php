...
require_once 'index_banner.php';
require_once 'index_bookSpecial.php';
                    ...
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right" id="quick-view-content">
                            ...
                            <div class="product-description border-product">
                                ...
                                <div class="qty-box">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="input-quatity" name="quatity" class="form-control input-number" value="1">
                                        <span class="input-group-prepend">
                            ...
                            <div class="product-buttons">
                                <a id="order-at-quick-view-book" href="#" class="btn btn-solid mb-1 btn-add-to-cart">Chọn Mua</a>
